...
def create_ascii_html(video_path, output_file="ascii_video.html", width=100):
    ...
    try:
        ...
        while True:
            ...
            if processed < 3:
                ...
                # 创建ASCII预览
                preview = create_ascii_preview(adjusted, ASCII_MAP, 30)
            ...
            # 显示进度
            if processed % 30 == 0 or processed == total_frames:
...
<body>
    <div id="ascii-container">
        ...
        <div class="stats">处理帧数: {processed} | FPS: 30 | 状态: <span id="status">加载中...</span></div>
    </div>
    ...
    <script>
        ...
        function renderFrame(timestamp) {{
            ...
            if (elapsed >= frameDelay) {{
                ...
                // 更新状态
                document.getElementById('status').textContent = `播放中 ${{currentFrame+1}}/${{frames.length}}`;
        ...
        window.addEventListener('DOMContentLoaded', () => {{
            ...
            if (frames.length > 0) {{
                ...
                document.getElementById('status').textContent = "错误: 无帧数据";
            }}
        }});
    </script>
</body>
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "ascii_video360.html"
    CHARACTER_WIDTH = 160  # 对于问题视频，减小宽度值
    ...
    create_ascii_html(VIDEO_PATH, OUTPUT_FILE, CHARACTER_WIDTH)
